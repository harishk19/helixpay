...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoutes() {
        ...
        return GatewayRouterFunctions.route("product_service")
                .route(RequestPredicates.path("/api/product"),HandlerFunctions.http(URI.create(productServiceUrl)))
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoutes() {
        return GatewayRouterFunctions.route("product_service_swagger")
                ...
                .http(URI.create(productServiceUrl)))
    ...
    public RouterFunction<ServerResponse> orderServiceRoutes(){
    	...
    	return GatewayRouterFunctions.route("order_service")
    			...
    			.http(URI.create(orderServiceUrl)))
    ...
    public RouterFunction<ServerResponse> inventoryService(){
    	return GatewayRouterFunctions.route("inventory_service")
    			...
    			.http(URI.create(inventoryServiceUrl)))
